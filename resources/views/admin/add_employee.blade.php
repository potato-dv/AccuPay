        ...
        <section class="add-employee-form">
            ...
            <form action="{{ route('admin.employees.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="middle_name" name="middle_name" value="{{ old('middle_name') }}" placeholder="Smith">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="birthdate" name="birthdate" value="{{ old('birthdate') }}" max="{{ date('Y-m-d', strtotime('-18 years')) }}" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="department" name="department" value="{{ old('department') }}" placeholder="IT" required>
                </div>
                <div class="form-group">
                    <label for="position">Position <span style="color: red;">*</span></label>
                    <input type="text" id="position" name="position" value="{{ old('position') }}" placeholder="Developer" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="john.doe@example.com" maxlength="255" required>
                </div>
                <div class="form-group">
                    <label for="phone">Phone Number <span style="color: red;">*</span></label>
                    <input type="tel" id="phone" name="phone" value="{{ old('phone') }}" placeholder="09123456789" pattern="[0-9]{10,11}" maxlength="11" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" id="basic_salary" name="basic_salary" value="{{ old('basic_salary') }}" placeholder="30000" min="0" max="999999999.99">
                </div>
                <div class="form-group">
                    <label for="hourly_rate">Hourly Rate (Optional)</label>
                    <input type="number" step="0.01" id="hourly_rate" name="hourly_rate" value="{{ old('hourly_rate') }}" placeholder="150" min="0" max="9999.99">
                </div>
                ...
                <div class="form-group">
                    ...
                    <small style="color: #666; font-size: 12px;">Defines working days and shift hours for this employee</small>
                </div>

                <!-- Government IDs -->
                <div class="form-group">
                    <label for="tax_id_number">TIN (Tax ID Number)</label>
                    <input type="text" id="tax_id_number" name="tax_id_number" value="{{ old('tax_id_number') }}" placeholder="123-456-789-000">
                </div>
                <div class="form-group">
                    <label for="sss_number">SSS Number</label>
                    <input type="text" id="sss_number" name="sss_number" value="{{ old('sss_number') }}" placeholder="12-3456789-0">
                </div>
                <div class="form-group">
                    <label for="philhealth_number">PhilHealth Number</label>
                    <input type="text" id="philhealth_number" name="philhealth_number" value="{{ old('philhealth_number') }}" placeholder="12-345678901-2">
                </div>
                <div class="form-group">
                    <label for="pagibig_number">Pag-IBIG Number</label>
                    <input type="text" id="pagibig_number" name="pagibig_number" value="{{ old('pagibig_number') }}" placeholder="1234-5678-9012">
                </div>

                <!-- Bank Information -->
                <div class="form-group">
                    <label for="bank_name">Bank Name</label>
                    <input type="text" id="bank_name" name="bank_name" value="{{ old('bank_name') }}" placeholder="BDO, BPI, Metrobank, etc.">
                </div>
                <div class="form-group">
                    <label for="bank_account_number">Bank Account Number</label>
                    <input type="text" id="bank_account_number" name="bank_account_number" value="{{ old('bank_account_number') }}" placeholder="1234567890">
                </div>

                <!-- Leave Credits -->
                <div class="form-group">
                    <label for="vacation_leave_credits">Vacation Leave Credits (Annual)</label>
                    <input type="number" id="vacation_leave_credits" name="vacation_leave_credits" value="{{ old('vacation_leave_credits', 15) }}" placeholder="15">
                </div>
                <div class="form-group">
                    <label for="sick_leave_credits">Sick Leave Credits (Annual)</label>
                    <input type="number" id="sick_leave_credits" name="sick_leave_credits" value="{{ old('sick_leave_credits', 15) }}" placeholder="15">
                </div>
                <div class="form-group">
                    <label for="emergency_leave_credits">Emergency Leave Credits (Annual)</label>
                    <input type="number" id="emergency_leave_credits" name="emergency_leave_credits" value="{{ old('emergency_leave_credits', 5) }}" placeholder="5">
                </div>

                <!-- Address / Emergency Contact -->
                <div class="form-group">
                    <label for="address">Address <span style="color: red;">*</span></label>
                    <input type="text" id="address" name="address" value="{{ old('address') }}" placeholder="123 Main St, City" maxlength="500" required>
                </div>
                <div class="form-group">
                    <label for="emergency_contact">Emergency Contact Name <span style="color: red;">*</span></label>
                    <input type="text" id="emergency_contact" name="emergency_contact" value="{{ old('emergency_contact') }}" placeholder="Jane Doe" maxlength="255" required>
                </div>
                <div class="form-group">
                    <label for="emergency_phone">Emergency Contact Phone <span style="color: red;">*</span></label>
                    <input type="tel" id="emergency_phone" name="emergency_phone" value="{{ old('emergency_phone') }}" placeholder="09123456789" pattern="[0-9]{10,11}" maxlength="11" required>
                    <small style="color: #666; font-size: 12px;">10-11 digits only</small>
                </div>

                <!-- Buttons -->
                <div class="form-actions">
                    <button type="submit" class="btn-theme">Add Employee</button>
